...
class Muon(torch.optim.Optimizer):
    ...
    def reset(self):
        ...
        for group in self.param_groups:
            ...
            group["second_momentum_buffer_row"].zero_()
            group["second_momentum_buffer_col"].zero_()
...
class Hyperparameters:
    ...
    # optimization
    num_scheduled_iterations: int = 2250  # number of steps to complete lr and ws schedule
