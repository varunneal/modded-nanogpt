...
class Hyperparameters:
    ...
    # optimization
    num_scheduled_iterations: int = 2210  # number of steps to complete lr and ws schedule
...
if master_process:
    ...
    logfile = f"logs/pre_wd_{str(WD)}_{run_id}.txt"
    print(logfile)
...
optimizer2 = NorMuon(hidden_matrix_params + gate_params, lr=0.03, momentum=0.95, beta2=0.95, weight_decay=WD)
